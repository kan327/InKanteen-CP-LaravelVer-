        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="post"
                        action="{{ isset($story) ? route('story.update', $story->id) : route('story.store') }}"
                        ...
                        <div>
                            ...
                            <div class="shrink-0 my-2">
                                <img id="featured_image_preview" class="h-64 w-128 object-cover rounded-md"
                                    src="{{ isset($story) ? Storage::url($story->featured_image) : '' }}"
                        ...
                        <div>
                            ...
                            <x-text-input id="title" name="title" type="text" class="mt-1 block w-full"
                                :value="$story->title ?? old('title')" required autofocus />
                        ...
                        <div>
                            ...
                            <x-textarea-input id="desc" name="desc" class="mt-1 block w-full" required
                                autofocus>{{ $story->desc ?? old('desc') }}</x-textarea-input>
                        ...
                        <div>
                            ...
                            <x-text-input id="tags" name="tags" type="text" class="mt-1 block w-full"
                                :value="$story->tags ?? old('tags')" required autofocus />
